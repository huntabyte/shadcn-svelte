...
<script lang="ts">
	import NavMain from "$lib/registry/default/block/sidebar-08/components/nav-main.svelte";
	import NavProjects from "$lib/registry/default/block/sidebar-08/components/nav-projects.svelte";
