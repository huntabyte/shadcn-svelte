...
<script lang="ts">
	import SearchForm from "$lib/registry/default/block/sidebar-02/components/search-form.svelte";
	import VersionSwitcher from "$lib/registry/default/block/sidebar-02/components/version-switcher.svelte";
