<script lang="ts">
	import SidebarLeft from "$lib/registry/new-york/blocks/sidebar-15/components/sidebar-left.svelte";
	import SidebarRight from "$lib/registry/new-york/blocks/sidebar-15/components/sidebar-right.svelte";
