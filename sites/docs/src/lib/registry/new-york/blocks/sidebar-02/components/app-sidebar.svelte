...
<script lang="ts">
	import SearchForm from "$lib/registry/new-york/blocks/sidebar-02/components/search-form.svelte";
	import VersionSwitcher from "$lib/registry/new-york/blocks/sidebar-02/components/version-switcher.svelte";
