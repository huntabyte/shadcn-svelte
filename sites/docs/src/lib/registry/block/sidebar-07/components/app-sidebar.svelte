...
<script lang="ts">
	import NavMain from "$lib/registry/block/sidebar-07/components/nav-main.svelte";
	import NavProjects from "$lib/registry/block/sidebar-07/components/nav-projects.svelte";
