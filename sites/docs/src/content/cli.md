...
<PMExecute command="shadcn-svelte@0.14 add [component]" />
...
<PMExecute command="shadcn-svelte@0.14 update [component]" />
...
```bash
HTTP_PROXY="<proxy-url>" npx shadcn-svelte@0.14 init
```
