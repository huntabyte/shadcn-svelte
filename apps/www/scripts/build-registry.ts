...
// ----------------------------------------------------------------------------
// Build __registry__/index.svelte.
// ----------------------------------------------------------------------------
...
// Write style index.
rimraf.sync(path.join(process.cwd(), "__registry__/index.svelte"));
fs.writeFileSync(path.join(process.cwd(), "__registry__/index.svelte"), index);
