...
export const Blocks = {
	"default": {
		...
		"dashboard-02": {
			name: "dashboard-02",
			type: "components:block",
			chunks: [ { name: "chunk-0", description: "A card with a call to action", container: { className: "" }, raw: () => import("./chunks/default/dashboard-02-chunk-0.svelte?raw").then((m) => m.default), component: () => import("./chunks/default/dashboard-02-chunk-0.svelte").then((m) => m.default) }, { name: "chunk-1", description: "An empty state showing no products with a heading, description and a call to action to add a product.", container: { className: "" }, raw: () => import("./chunks/default/dashboard-02-chunk-1.svelte?raw").then((m) => m.default), component: () => import("./chunks/default/dashboard-02-chunk-1.svelte").then((m) => m.default) }],
		...
		"dashboard-03": {
			name: "dashboard-03",
			type: "components:block",
			chunks: [ { name: "chunk-0", description: "A settings form a configuring an AI model and messages.", container: { className: "" }, raw: () => import("./chunks/default/dashboard-03-chunk-0.svelte?raw").then((m) => m.default), component: () => import("./chunks/default/dashboard-03-chunk-0.svelte").then((m) => m.default) }, { name: "chunk-1", description: "A form for sending a message to an AI chatbot. The form has a textarea and buttons to upload files and record audio.", container: { className: "" }, raw: () => import("./chunks/default/dashboard-03-chunk-1.svelte?raw").then((m) => m.default), component: () => import("./chunks/default/dashboard-03-chunk-1.svelte").then((m) => m.default) }],
		...
		"dashboard-02": {
			name: "dashboard-02",
			type: "components:block",
			chunks: [ { name: "chunk-0", description: "A card with a call to action", container: { className: "" }, raw: () => import("./chunks/new-york/dashboard-02-chunk-0.svelte?raw").then((m) => m.default), component: () => import("./chunks/new-york/dashboard-02-chunk-0.svelte").then((m) => m.default) }, { name: "chunk-1", description: "An empty state showing no products with a heading, description and a call to action to add a product.", container: { className: "" }, raw: () => import("./chunks/new-york/dashboard-02-chunk-1.svelte?raw").then((m) => m.default), component: () => import("./chunks/new-york/dashboard-02-chunk-1.svelte").then((m) => m.default) }],
