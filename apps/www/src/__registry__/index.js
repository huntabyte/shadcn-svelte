...
export const Index = {
	"default": {
		...
		"dashboard-06": {
			...
			files: [],
			chunks: [{ name: "chunk-0", raw: () => import("./chunks/default/dashboard-06-chunk-0.svelte?raw").then((m) => m.default), component: () => import("./chunks/default/dashboard-06-chunk-0.svelte").then((m) => m.default) }],
