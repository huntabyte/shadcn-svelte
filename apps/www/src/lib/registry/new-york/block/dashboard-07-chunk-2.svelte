...
<Card.Root data-x-chunk="dashboard-07-chunk-2">
	<Card.Header>
		...
		<div class="grid gap-6 sm:grid-cols-3">
			...
			<div class="grid gap-3">
				...
				<Select.Root>
					...
					<Select.Content>
						<Select.Item value="t-shirts">T-Shirts</Select.Item>
						<Select.Item value="hoodies">Hoodies</Select.Item>
						<Select.Item value="sweatshirts">Sweatshirts</Select.Item>
					</Select.Content>
				</Select.Root>
			</div>
		</div>
