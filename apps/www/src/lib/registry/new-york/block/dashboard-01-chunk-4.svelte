...
<Card.Root class="xl:col-span-2" data-x-chunk="dashboard-01-chunk-4">
		...
		<Table.Root>
			<Table.Header>
				<Table.Row>
					...
					<Table.Head class="hidden xl:table-column">Type</Table.Head>
					<Table.Head class="hidden xl:table-column">Status</Table.Head>
					<Table.Head class="hidden xl:table-column">Date</Table.Head>
			...
			<Table.Body>
				<Table.Row>
					...
					<Table.Cell class="hidden xl:table-column">Sale</Table.Cell>
					<Table.Cell class="hidden xl:table-column">
						<Badge class="text-xs" variant="outline">Approved</Badge>
					</Table.Cell>
					<Table.Cell class="hidden md:table-cell lg:hidden xl:table-column">
						2023-06-23
					</Table.Cell>
				...
				<Table.Row>
					...
					<Table.Cell class="hidden xl:table-column">Refund</Table.Cell>
					<Table.Cell class="hidden xl:table-column">
				...
				<Table.Row>
					...
					<Table.Cell class="hidden xl:table-column">Subscription</Table.Cell>
					<Table.Cell class="hidden xl:table-column">
						<Badge class="text-xs" variant="outline">Approved</Badge>
					</Table.Cell>
					<Table.Cell class="hidden md:table-cell lg:hidden xl:table-column">
