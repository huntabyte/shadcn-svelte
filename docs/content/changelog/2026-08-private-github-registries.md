...
<PMExecute command="shadcn-svelte@latest add acme/internal-toolkit/auth-kit" />
...
<PMExecute command="shadcn-svelte@latest registry validate acme/internal-toolkit" />
...
See the [Private repositories](/docs/registry/github#private-repositories) docs for the full guide.
