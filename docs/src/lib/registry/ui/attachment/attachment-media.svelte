<script lang="ts" module>
	...
	export const attachmentMediaVariants = tv({
		base: "cn-attachment-media group-data-[state=error]/attachment:bg-destructive/10 group-data-[state=error]/attachment:text-destructive relative flex aspect-square shrink-0 items-center justify-center overflow-hidden [&_svg]:pointer-events-none",
		variants: {
			variant: {
				icon: "",
