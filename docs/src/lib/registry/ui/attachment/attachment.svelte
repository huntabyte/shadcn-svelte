<script lang="ts" module>
	...
	export const attachmentVariants = tv({
		base: "cn-attachment group/attachment bg-card text-card-foreground has-[>a,>button]:hover:bg-muted/50 data-[state=error]:border-destructive/30 relative flex max-w-full min-w-0 shrink-0 flex-wrap border transition-colors data-[state=idle]:border-dashed",
		variants: {
			size: {
