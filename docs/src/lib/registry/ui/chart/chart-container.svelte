...
<div
	...
	class={cn(
		...
		"[&_.lc-area-path]:opacity-100 [&_.lc-highlight-line]:opacity-100 [&_.lc-highlight-point]:opacity-100 [&_.lc-path:not(.lc-bar):not(.lc-arc-line)]:opacity-100 [&_.lc-text]:text-xs [&_.lc-text-svg]:overflow-visible",
