...
<Example title="Group Chat">
	<div class="flex w-full max-w-md flex-col gap-10">
		<Message.Root align="end">
			<Message.Content>
				<Bubble.Root variant="tinted">
					<Bubble.Content>Why is the dashboard showing zero users</Bubble.Content>
				</Bubble.Root>
			</Message.Content>
		</Message.Root>
		<Message.Group>
			<Message.Root>
				...
				<Message.Content>
					<Bubble.Root variant="muted">
						<Bubble.Content>Define "zero."</Bubble.Content>
					</Bubble.Root>
				</Message.Content>
			</Message.Root>
			<Message.Root>
				...
				<Message.Content>
					<Bubble.Root variant="muted">
						<Bubble.Content>What do you mean?</Bubble.Content>
					</Bubble.Root>
				</Message.Content>
			</Message.Root>
		</Message.Group>
		<Message.Root align="end">
			<Message.Content>
				<Bubble.Root variant="tinted">
					<Bubble.Content><span class="font-medium">@eve</span> can you check?</Bubble.Content>
				</Bubble.Root>
			</Message.Content>
		</Message.Root>
		<Message.Root>
		...
		<Message.Root>
			<Message.Content>
				<Message.Header>Eve</Message.Header>
