	...
	<div class="flex w-full max-w-sm flex-col gap-8">
		<Message.Root align="end">
			<Message.Content>
				...
				<Bubble.Root>
					<Bubble.Content>Here are the brand photos. Can you add them to the deck?</Bubble.Content>
				</Bubble.Root>
			</Message.Content>
		</Message.Root>
		<Message.Root>
			<Message.Content>
				<Bubble.Root variant="muted">
					<Bubble.Content>Done. Here's the draft deck and the exported assets.</Bubble.Content>
				</Bubble.Root>
				<Attachment.Group class="w-full">
					<Attachment.Root class="w-64">
						...
						<Attachment.Content>
							<Attachment.Title>brand-deck.pdf</Attachment.Title>
							<Attachment.Description>PDF · 3.1 MB</Attachment.Description>
						</Attachment.Content>
						<Attachment.Actions>
							<Attachment.Action
								type="button"
					...
					<Attachment.Root class="w-64">
						...
						<Attachment.Content>
							<Attachment.Title>brand-deck.key</Attachment.Title>
							<Attachment.Description>Keynote · 9 MB</Attachment.Description>
						</Attachment.Content>
						<Attachment.Actions>
							<Attachment.Action
								type="button"
					...
					<Attachment.Root class="w-64">
						...
						<Attachment.Content>
							<Attachment.Title>brand-assets.zip</Attachment.Title>
							<Attachment.Description>ZIP · 4.2 MB</Attachment.Description>
						</Attachment.Content>
						<Attachment.Actions>
							<Attachment.Action
								type="button"
