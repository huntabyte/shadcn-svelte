...
<Accordion.Root type="multiple" class="w-full" value={["item-1"]}>
	<Accordion.Item value="item-1">
		...
		<Accordion.Content>
			Manage how and when you receive notifications. You can customize alerts for email, push,
			and in-app messages.
		</Accordion.Content>
	</Accordion.Item>
	<Accordion.Item value="item-2">
		...
		<Accordion.Content>
			Control your privacy settings and manage your account security. Enable two-factor
	...
	<Accordion.Item value="item-3">
		...
		<Accordion.Content>
			View and manage your subscription, payment methods, and billing history. Update your
			plan or cancel at any time.
		</Accordion.Content>
	</Accordion.Item>
</Accordion.Root>
