<script lang="ts">
	import * as Typeset from "$lib/registry/ui/typeset/index.js";
...
<Typeset.Root class="w-full">
	<!-- eslint-disable-next-line svelte/no-at-html-tags -- trusted static fixture from shadcn/ui -->
	{@html docsHtml}
</Typeset.Root>
