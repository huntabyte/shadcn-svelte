	...
	<Card.Content class="relative p-0 md:pr-48">
		<div class="p-6">
			<Calendar
				...
				class="data-unavailable:line-through data-unavailable:opacity-100 bg-transparent p-0 [--cell-size:--spacing(10)] md:[--cell-size:--spacing(12)] **:data-outside-month:hidden"
				weekdayFormat="short"
			/>
		</div>
		<div
