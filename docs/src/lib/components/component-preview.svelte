...
{#if type === "block"}
	...
	>
		<img
			...
			width={1440}
			height={900}
			class="bg-background sm:w-7xl absolute start-0 top-0 z-20 w-[970px] max-w-none md:hidden dark:hidden md:dark:hidden"
		/>
		<img
			...
			width={1440}
			height={900}
			class="bg-background sm:w-7xl absolute start-0 top-0 z-20 hidden w-[970px] max-w-none md:hidden dark:block md:dark:hidden"
		/>
