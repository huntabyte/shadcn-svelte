...
<button
	class="text-(--text) aspect-3/1 sm:aspect-2/3 group relative flex w-full flex-1 cursor-pointer flex-col gap-2 sm:h-auto sm:w-auto [&>svg]:absolute [&>svg]:right-4 [&>svg]:top-4 [&>svg]:z-10 [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:opacity-0 [&>svg]:transition-opacity"
